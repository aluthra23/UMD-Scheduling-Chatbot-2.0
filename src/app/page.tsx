...
export default function Home() {
  ...
  return (
    <div className="flex flex-col h-screen bg-gradient-to-b from-[#0e0e0e] to-black">
      {/* Header */}
      <header className="header-gradient text-white py-3 px-4">
        <div className="flex items-center justify-between">
          ...
          <a 
            ...
            className="text-white hover:text-[var(--umd-gold)] transition-colors"
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        {messages.map((message) => (
          ...
          >
            <div 
              className={`message-bubble text-base ${
      ...
      <form 
        ...
        className="footer-gradient border-t border-gray-900 p-4"
      >
        <div className="flex space-x-2">
          <textarea
            ref={textareaRef}
